...
public class Main {
	...
	public static void main(String[] args) {
		...
		do{
			try{
				erreurRequete=false;
				afficherTable(effectuerRequete(selectionnerDonnees(connect),connect));
				System.out.println("passage");
				insererRequete("insert into projettutore.equipe values(DEFAULT,'ajax','Pays-bas')",connect);
				afficherTable(effectuerRequete(selectionnerDonnees(connect),connect));
			}catch(SQLException e){
				erreurRequete=true;
